...
require_once STWI_PLUGIN_DIR . '/libraries/action-scheduler/action-scheduler.php';
...
function stwi_activate() {
    ...
    $sql = "CREATE TABLE {$wpdb->prefix}stwi_imports (
...
register_uninstall_hook(__FILE__, 'stwi_drop_imports_table');
function stwi_drop_imports_table() {
    global $wpdb;
    $table_name = $wpdb->prefix . 'stwi_imports';
